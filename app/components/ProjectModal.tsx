  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {activeProject === "Goji Health"
            ? "Co-founded startup that uses AI to predict demand for healthcare supply chain services. Spoke with directors of supply chain at hospitals around the country to understand their pain points. Won 2nd place and $15K on the Technology track from the Columbia Venture Competition."
            : activeProject === "Senior Scramble"
